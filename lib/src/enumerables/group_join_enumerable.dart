...
class GroupJoinEnumerable<TSource, TInner, TKey, TResult> extends Enumerable<TResult> with EnumerableWithSource<TSource> {
  ...
  GroupJoinEnumerable(Enumerable<TSource> source, this.inner, this.outerKeySelector, this.innerKeySelector, this.resultSelector, EqualityComparer<TKey> keyComparer)
