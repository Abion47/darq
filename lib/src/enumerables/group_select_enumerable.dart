...
class GroupSelectEnumerable<TSource, TKey, TResult> extends Enumerable<TResult> with EnumerableWithSource<TSource> {
  ...
  GroupSelectEnumerable(Enumerable<TSource> source, this.keySelector, this.resultSelector, EqualityComparer<TKey> keyComparer)
  ...
  Iterator<TResult> get iterator {
    final lookup = Lookup.create<TSource, TKey, TSource>(source, keySelector, (e) => e, keyComparer);
