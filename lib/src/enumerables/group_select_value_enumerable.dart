...
class GroupSelectValueEnumerable<TSource, TKey, TValue, TResult> extends Enumerable<TResult> with EnumerableWithSource<TSource> {
  ...
  GroupSelectValueEnumerable(Enumerable<TSource> source, this.keySelector, this.valueSelector, this.resultSelector, EqualityComparer<TKey> keyComparer)
  ...
  Iterator<TResult> get iterator {
    final lookup = Lookup.create<TSource, TKey, TValue>(source, keySelector, valueSelector, keyComparer);
