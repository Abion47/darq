extension InsertOrAppendWhereExtension<T> on Iterable<T> {
  ...
  /// element is found, [value] will be inserted at the end.
  Iterable<T> insertOrAppendWhere(
    T value,
