...
extension JoinMapExtension<T> on Iterable<T> {
  /// Finds keys in this iterable with matching keys in the [inner] collection
  /// and returns a value that is the result of the corresponding elements being
  /// merged.
  ///
  /// First, [joinMap] will iterate over the [inner] collection and make a lookup
  ...
  /// element are passed through the [resultSelector]. The returned value of
  /// [resultSelector] is then added to the resulting iterable.
  ///
  /// Elements in the source iterable that doesn't share a key in the
  /// lookup table as well as elements in [inner] that don't share a key with a
